...
- The one feature regression model has the same training error and test error as the baseline model. The one variable used in this linear regression to the multiplication of total heated area at sale and the assessed grade difference.
